/**
 * University Course Schedule Visualization - Map View (Bounded) - Capacity Version
 *
 ...
 * This version uses fixed bounds to restrict the map view.
 * This version uses room capacity instead of max_enrollment.
 */
...
/**
 * Initialize the Leaflet map with fixed bounds
 */
function initMap() {
    ...
    // Calculate bounds from the corner points
    // For Leaflet, we need southwest (min lat, min lng) and northeast (max lat, max lng)
...
function renderVisualization() {
    ...
    Object.keys(buildingCoordinates).forEach(buildingName => {
        ...
        rooms.forEach((room, index) => {
            ...
            const classroomHtml = `
                <div class="classroom-cell ${statusClass} ${borderClass}"
